...
IDS Functionalities  | Trusted Connector |	Dataspace Connector	| EI Connector |	TNO Trusted Connector |	GEC  Connector| DIH Connector	| Orbiter Connector	| Open Data Connector	| OPC UA Factory Connector
--- | --- | --- | --- | --- | --- | --- | --- | --- | --- 
...
Further Functionalities/Features | Trusted Connector |	Dataspace Connector	| EI Connector |	TNO Trusted Connector |	GEC  Connector| DIH Connector	| Orbiter Connector	| Open Data Connector	| OPC UA Factory Connector
--- | --- | --- | --- | --- | --- | --- | --- | --- | ---
